...
(function () {
    ...
    candidateController.$inject = ['candidateService', 'entityManagerFactory']; //, 'getCandidateService'

    function candidateController(candidateService, entityManagerFactory) { //, getCandidateService
